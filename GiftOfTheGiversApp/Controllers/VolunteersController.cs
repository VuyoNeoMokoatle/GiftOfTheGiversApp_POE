...
namespace GiftOfTheGiversApp.Controllers
{
    public class VolunteersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VolunteerID,FullName,Email,Skills,Availability")] Volunteer volunteer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VolunteerID,FullName,Email,Skills,Availability")] Volunteer volunteer)
        {
